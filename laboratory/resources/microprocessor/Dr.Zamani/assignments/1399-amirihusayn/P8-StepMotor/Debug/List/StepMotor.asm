...
_0x3:
	.DB  0x8,0xC,0x4,0x6,0x2,0x3,0x1,0x9
_0x4:
	.DB  0x8,0x4,0x2,0x1
_0x5:
	.DB  0x9,0xC,0x6,0x3
...
; 0000 0022             PORTB = halfStep[index];
	MOV  R30,R17
	LDI  R31,0
	SUBI R30,LOW(-_halfStep)
	SBCI R31,HIGH(-_halfStep)
	RCALL SUBOPT_0x0
...
; 0000 002B             PORTB = halfStep[index];
	LDI  R26,LOW(_halfStep)
	LDI  R27,HIGH(_halfStep)
	RCALL SUBOPT_0x1
...
; 0000 0039             PORTB = fullStep[index];
	MOV  R30,R17
	LDI  R31,0
	SUBI R30,LOW(-_fullStep)
	SBCI R31,HIGH(-_fullStep)
	RCALL SUBOPT_0x0
...
; 0000 0042             PORTB = fullStep[index];
	LDI  R26,LOW(_fullStep)
	LDI  R27,HIGH(_fullStep)
	RCALL SUBOPT_0x1
...
; 0000 004F             PORTB = fastFullStep[index];
	MOV  R30,R17
	LDI  R31,0
	SUBI R30,LOW(-_fastFullStep)
	SBCI R31,HIGH(-_fastFullStep)
	RCALL SUBOPT_0x0
...
; 0000 0058             PORTB = fastFullStep[index];
	LDI  R26,LOW(_fastFullStep)
	LDI  R27,HIGH(_fastFullStep)
	RCALL SUBOPT_0x1
...
; 0000 0070                   FullStep_Fast_ClockWise();
	RCALL _FullStep_Fast_ClockWise
; 0000 0071                   break;
; 0000 0072             }
; 0000 0073             default :
_0x1E:
...
; 0000 0095             FullStep_Fast_AntiClockWise();
	RCALL _FullStep_Fast_AntiClockWise
